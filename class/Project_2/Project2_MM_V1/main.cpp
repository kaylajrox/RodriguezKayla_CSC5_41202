...
//Function Prototypes
void compic(char&,char&,char&,char&);
void inputC(char&,char&,char&,char&);
void switchH(char,char,char,char,char,char,char,char,bool,char);
void reppic(char,char,char,char,char,char,char,char,int&,const char,
            const char,int);
void results(char,char,char,char,char,char,char,char,int&,const char,
        const char,int&);
...
//Function Outputs
compic(pick1,pick2,pick3,pick4);
cout<<"The computers colors are "<<pick1<<" "<<pick2<<" "<<pick3<<" ";
cout<<pick4<<endl;
for(int n=1;n<=limit;n++){
    inputC(color1,color2,color3,color4);
    switchH(color1,color2, color3,color4,pick1,pick2,pick3,pick4,hintR,hint);
    reppic(color1,color2,color3,color4,pick1,pick2,pick3,pick4,nTrys,CNVPERC,
            GMELMT,limit);
}
results(color1,color2,color3,color4,pick1,pick2,pick3,pick4,nTrys,
        CNVPERC,GMELMT,limit);
...
void compic(char &pick1,char &pick2,char &pick3,char &pick4){
do{
    pick1=rand()%24+66;     
...
/******************************************************************************/
void inputC(char &color1,char &color2,char &color3,char &color4){
    do{
...
/******************************************************************************/
void reppic(char color1,char color2,char color3, char color4,char pick1, 
        char pick2,char pick3,char pick4,int &nTrys,const char CNVPERC,
        const char GMELMT,int limit){
...
/******************************************************************************/
void results(char color1,char color2,char color3, char color4,char pick1, 
        char pick2,char pick3,char pick4,int &nTrys,const char CNVPERC,
        const char GMELMT,int &limit){
...
/******************************************************************************/
void switchH(char color1,char color2,char color3, char color4,char pick1, 
        char pick2,char pick3,char pick4,bool hintR,char hint){ 
    do{
