...
ofstream out;
//Open the File
out.open("Mastermind.txt",ios::out);
...
for (int n=1;n<=limit;n++){
        ...
        do{
            ...
            cout<<"Type 1 to display how many colors are correct but not in right spot."<<endl;
            cout<<"Type 2 to display how many colors are correct and in the ";
...
//Reveals Computer's Choice Once User Guesses
    out<<"The computers colors are "<<pick1<<" "<<pick2<<" "<<pick3<<" ";
    out<<pick4<<endl;
    out<<"Your colors are "<<color1<<" "<<color2<<" "<<color3<<" ";
    out<<color4<<endl;
    out<<"Your total number of tries is "<<nTrys<<endl;
    if(nTrys<GMELMT&&color1==pick1&&color2==pick2&&color3==pick3&&color4==pick4){
        ...
        out<<"You lose. You could not guess below 10 tries."<<endl;
    }
