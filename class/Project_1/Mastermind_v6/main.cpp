...
do{
    ...
    //User Inputs
        do{
            do{
                cout<<"Pick your first color "<<endl;      
                cin>>color1;
                ...
                switch (hint){
                    case 49:{
                        if (color1==pick2||color1==pick3||color1==pick4){
                            cout<<"Your choice for the first color is correct; ";
                    ...
                    case 50:{
                        if (color2==pick1||color2==pick3||color2==pick4){
                            cout<<"Your choice for the second color is correct; ";
                            cout<<"however, it is not in the right spot."<<endl;
                            cout<<"Change the order of which you ";
                            cout<<"input this color to get it in the right spot.";
                            cout<<endl<<endl;
                    ...
                    case 51:{
                        if (color3==pick2||color3==pick1||color3==pick4){
                            cout<<"Your choice for the third color is correct; "; 
                            cout<<"however, it is not in the right spot."<<endl; 
                            cout<<"Change the order of which you ";
                            cout<<"input this color to get it in the right spot.";
                            cout<<endl<<endl;
                    ...
                    case 52:{
                        if (color4==pick2||color4==pick3||color4==pick1){
                            cout<<"Your choice for the fourth color is correct; ";
                    ...
                    case 53:{
                        ...
                        if (color1==pick1||color2==pick2||color3==pick3||
                                color4==pick4){
                            cout<<"One of your colors is in the correct spot.";
                            cout<<endl;
                        //Two in the correct spot
                        }else if(color1==pick1&&color2==pick2){
                            cout<<"Two of your colors are in the correct spot.";
                            cout<<endl;
                        ...
                        //Three in the correct spot
                            ...
                            cout<<"Three of your colors are in the right spot.";
                            cout<<endl;
            ...
            nTrys++;
            cout<<"# of Tries\tColor Choices"<<endl;
            cout<<"----------------------------"<<endl;
            string display="";
                display+="----------------------------";
            for(int nChoice=1;nChoice<=nTrys;nChoice++){
                //Display
